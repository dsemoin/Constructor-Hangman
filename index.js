      ...
      inquirer.prompt([{
        ...
        var guessedAlready = false;
          ...
          if(guessedAlready === false){
            ...
            var found = that.currentWord.guess(letterReturned);
            ...
            if(found === 0){
              ...
              console.log('\n*******************');
              console.log(that.currentWord.currentWord());
              console.log('\n*******************');
            ...
            console.log("Guesses Remaining", that.guessesRemaining)
            if(that.guessesRemaining > 0 && that.currentWord.didWeFindTheWord() === false) {
              that.keepPromptingUser();
            }else if(that.guessesRemaining === 0){
              console.log('Game over!');
              console.log('The word you were guessing was: ' + that.currentWord.fullWord);
            }
          } else{
